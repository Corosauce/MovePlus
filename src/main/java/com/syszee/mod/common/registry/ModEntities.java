...
public class ModEntities
{
     ...
     * @param properties     The properties for the egg item
     * @param <T>            The type of entity being created
     */
    private static <T extends Entity> RegistryObject<EntityType<T>> register(String id, EntityType.Builder<T> builder, int primaryColor, int secondaryColor, Item.Properties properties)
    {
        RegistryObject<EntityType<T>> object = register(id, builder);
        ModItems.ITEMS.register(id + "_spawn_egg", () -> new SpawnEggItemBase<>(object, primaryColor, secondaryColor, true, properties));
        return object;
    }
